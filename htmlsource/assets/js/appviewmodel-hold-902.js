function formObject(data) {
    ...
    self.computedValuesAvailable = ko.pureComputed(function() {
        if (self.Sex() != null && self.Age() != null && self.Age() >= 20 && self.Age() <= 79 && self.Race() != null && self.HDLCholesterol() != null && self.HDLCholesterol() >= 20 && self.HDLCholesterol() <= 100 && self.BloodPressure() != null && self.BloodPressure() >= 90 && self.BloodPressure() <= 200 && self.TotalCholesterol() != null && self.TotalCholesterol() >= 130 && self.TotalCholesterol() <= 320) {
            console.log("computedValuesAvailable True");
            return true;
        } else {
            console.log("computedValuesAvailable False");
            return false;
        }
    }, self);
    ...
    self.AgeConverted = ko.pureComputed(function() {
        if( self.isRealNumber(self.Age()) ){
            console.log(self.Age() + " is the Age");
            return Math.log( self.Age() );
        }
        return NaN;
    }, self);
    self.AgeSquared = ko.pureComputed(function() {
        if( self.isRealNumber(self.AgeConverted() ) ){
            return self.AgeConverted() * self.AgeConverted();
        }
        return NaN;
    }, self);
    self.HDLCholesterolConverted = ko.pureComputed(function() {
        if( self.isRealNumber(self.HDLCholesterol()) ){
            return Math.log( self.HDLCholesterol() );
        }
        return NaN;
    }, self);
    self.TotalCholesterolConverted = ko.pureComputed(function() {
        if( self.isRealNumber( self.TotalCholesterol()) ){
           return Math.log( self.TotalCholesterol() );
        }
        return NaN;
    }, self);
    self.agetc = ko.pureComputed(function() {
        return self.TotalCholesterolConverted() * self.AgeConverted();
    }, self);
    self.agehdl = ko.pureComputed(function() {
        return self.HDLCholesterolConverted() * self.AgeConverted();
    }, self);
    self.agetsbp = ko.pureComputed(function() {
        return self.AgeConverted() * self.trlnsbp();
    }, self);
    self.agentsbp = ko.pureComputed(function() {
        return self.AgeConverted() * self.ntlnsbp();
    }, self);
    self.trlnsbp = ko.pureComputed(function() {
        return Math.log(self.BloodPressure()) * Number(self.Hypertension())
    }, self);
    self.ntlnsbp = ko.pureComputed(function() {
        return Math.log(self.BloodPressure()) * Number(!self.Hypertension())
    }, self);
    self.agesmoke = ko.pureComputed(function() {
        return self.AgeConverted() * Number(self.Smoker());
    }, self);
    self.agedm = ko.pureComputed(function() {
        return self.AgeConverted() * Number(self.Diabetic);
    }, self);
    //Optimal Values
    self.opt_hdl = ko.pureComputed(function() {
        return Math.log(50);
    }, self);
    self.opt_tc = ko.pureComputed(function() {
        return Math.log(170);
    }, self);
    self.opt_agetc = ko.pureComputed(function() {
        return self.opt_tc() * self.AgeConverted();
    }, self);
    self.opt_agehdl = ko.pureComputed(function() {
        return self.opt_hdl() * self.AgeConverted();
    }, self);
    self.opt_agetsbp = ko.pureComputed(function() {
        return self.AgeConverted() * self.opt_trlnsbp();
    }, self);
    self.opt_agentsbp = ko.pureComputed(function() {
        return self.AgeConverted() * self.opt_ntlnsbp();
    }, self);
    self.opt_trlnsbp = ko.pureComputed(function() {
        return Math.log(110) * Number(false)
    }, self);
    self.opt_ntlnsbp = ko.pureComputed(function() {
        return Math.log(110) * Number(!false)
    }, self);
    self.otp_agesmoke = ko.pureComputed(function() {
        return self.AgeConverted() * Number(false);
    }, self);
    self.opt_agedm = ko.pureComputed(function() {
        return self.AgeConverted() * Number(false);
    }, self);
    self.s010 = ko.pureComputed(function() {
        var i;
    ...
    self.mnxb = ko.pureComputed(function() {
        var i = NaN;
    ...
    self.predict = ko.pureComputed(function() {
        var i = NaN;
    ...
    self.optimalPredict = ko.pureComputed(function() {
        var i = NaN;
    ...
    self.cvdPredict = ko.pureComputed(function() {
        if( self.isRealNumber(this.s010()) && self.isRealNumber(this.predict()) && self.isRealNumber(this.mnxb()) && ){
    ...
    self.optimalCvdPredict = ko.pureComputed(function() {
        if( self.isRealNumber(this.s010()) && self.isRealNumber(this.optimalPredict()) && self.isRealNumber(this.mnxb()) && ){
...
function viewModel() {
    ...
    self.resetAll = function() {
        ...
        console.log("Reset");
        gaWrapper('send', 'event', 'Mailto', 'Clicked button', 'Email');
